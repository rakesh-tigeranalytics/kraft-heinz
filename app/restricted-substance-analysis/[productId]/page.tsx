  ...
  Methylparaben: [
    {
      ...
      details:
        "Widely accepted preservative with excellent safety profile and regulatory approval across all regions.",
      hazardLevel: "Low",
      costImpact: "Low",
    ...
    },
    {
      ...
      details:
        "Natural preservative derived from fruits, offering excellent safety and performance characteristics.",
      hazardLevel: "Low",
      costImpact: "Medium",
      performanceImpact: "Low",
      compatibility: "High",
  ...
  "1,4-Dioxane": [
    {
      ...
      details:
        "Alternative processing aid that eliminates 1,4-Dioxane formation during manufacturing.",
      hazardLevel: "Low",
      costImpact: "Medium",
      performanceImpact: "Low",
      compatibility: "High",
  ...
  Formaldehyde: [
    {
      ...
      details:
        "High-performance adhesive system that eliminates formaldehyde emissions.",
      hazardLevel: "Low",
      costImpact: "High",
...
export default function RestrictedSubstanceAnalysis() {
  ...
  const restrictedMaterials = billOfMaterials.filter(
    (material) => material.status === "Restricted"
  );
  const allowedMaterials = billOfMaterials.filter(
    (material) => material.status === "Allowed"
  );
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-black">
                      Impact Analysis for {selectedSubstitute.name} Substitution
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="text-center">
                        <span className="text-2xl font-bold text-black">
                          {productionVolume[0].toLocaleString()}
                        </span>
                    ...
                    <p className="text-xs text-gray-600 mt-2">
                      Adjust production volume to see how it affects the
                      financial impact of the substitution.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-red-50 p-6 rounded-lg border border-red-200">
                    ...
                    <p className="text-xs text-red-700 mt-1">
                      Raw material cost increase per year
                    </p>
                  </div>
                  ...
                  <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                    ...
                    <p className="text-xs text-green-700 mt-1">
                      Revenue protection and growth per year
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                    ...
                    <div className="text-2xl font-bold text-blue-900">
                      ${financialImpact.netImpact.toFixed(1)}K
                    </div>
                    <p className="text-xs text-blue-700 mt-1">
                      Net financial benefit per year
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div className="flex flex-col h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-black">
                    Product Details & Restricted Substance Analysis
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-red-900 mb-1">
                      {product.restrictedMaterials} Restricted Materials
                      Identified
                    </h4>
                    <p className="text-sm text-red-800">
                      This product contains materials that are restricted in
                      certain regions. Review the Bill of Materials below for
                      details and available substitutes.
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {material.status === "Restricted" && (
                            <Button
                              onClick={() =>
                                handleFindSubstitute(material.material)
                              }
                              variant={
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {Object.keys(selectedSubstitutes).length} substitute(s)
                      selected for analysis
                    </p>
                    <div className="flex flex-wrap gap-2 mt-3">
                      {Object.entries(selectedSubstitutes).map(
                        ([material, substitute]) => (
                          <div
                            key={material}
                  ...
                  <Button
                    onClick={() => {
                      ...
                      const firstSubstitute =
                        Object.values(selectedSubstitutes)[0];
      ...
      <Dialog open={showSubstitutes} onOpenChange={setShowSubstitutes}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            <DialogTitle>
              Available Substitutes for {selectedMaterial}
            </DialogTitle>
            <p className="text-sm text-gray-600">
              {substitutes[selectedMaterial as keyof typeof substitutes]
                ?.length || 0}{" "}
              options found
            </p>
          </DialogHeader>
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto">
            {substitutes[selectedMaterial as keyof typeof substitutes]?.map(
              (substitute, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div className="text-center">
                      ...
                      <div
                        className={`text-xs font-medium px-2 py-1 rounded ${getImpactColor(
